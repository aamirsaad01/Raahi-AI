-- ============================================================
-- Migration: Add Travel Corridors (multi-city road-trip model)
-- ============================================================

-- Table A: travel_corridors
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_trigger WHERE tgname = 'travel_corridors_set_updated_at'
    ) THEN
...
-- Table B: corridor_locations (junction table)
...
CREATE INDEX IF NOT EXISTS idx_corridor_locations_corridor
    ON corridor_locations(corridor_id);
CREATE INDEX IF NOT EXISTS idx_corridor_locations_location
    ON corridor_locations(location_id);
